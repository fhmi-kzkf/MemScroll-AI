                    ...
                    if (l === J) {
                        ...
                        if (!(typeof p != "string" || p === "" || !m.widgetMap.has(p))) {
                            ...
                            if (o !== void 0) switch (n.event) {
                                case "init":
                                    {
                                        o.widgetInitStartTimeTsMs = Y(),
                                        o.kills = n.kills,
                                        Nt(o) && (o.gcs.length = 0);
                                        var E = o.shadow.querySelector("#".concat(c));A(E, HTMLElement) || b("Cannot initialize Widget, Element not found (#".concat(c, ")."), 3074),
                                        o.mode = n.mode,
                                        o.nextRcV = n.nextRcV,
                                        o.mode === de.Invisible && o.params["refresh-expired"] === Be.Manual && w("refresh-expired=manual is impossible in invisible mode, consider using '".concat(Be.Auto, "' or '").concat(Be.Never, ".'")),
                                        o.mode !== de.Managed && o.params["refresh-timeout"] !== nt.Auto && w("setting refresh-timeout has no effect on an invisible/non-interactive widget and will be ignored."),
                                        o.params.appearance === re.Always || o.isExecuting && o.params.appearance === re.Execute ? Ht(E, o) : va(E),
                                        E.style.display = "";
                                        var h = De(o, c);h || b("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                                        ie(h, {
                                            event: "init",
                                            source: J,
                                            widgetId: n.widgetId
                                ...
                                case "translationInit":
                                    {
                                        var y = o.shadow.querySelector("#".concat(c));A(y, HTMLElement) || b("Cannot initialize Widget, Element not found (#".concat(c, ")."), 3074);
                                        var P = new Map;o.displayLanguage = n.displayLanguage,
                                        o.displayRtl = n.displayRtl,
                                        Object.keys(n.translationData).forEach(function(Ue) {
                                ...
                                case "languageUnsupported":
                                    {
                                        w("Language ".concat(o.params.language, " is not supported, falling back to: ").concat(n.fallback, ".")),
                                        o.displayLanguage = n.fallback;
                                        break
                                    }
                                case "reject":
                                    {
                                        var S = o.shadow.querySelector("#".concat(c));o.isExecuting = !1,
                                        A(S, HTMLElement) || b("Cannot initialize Widget, Element not found (#".concat(c, ")."), 3075);
                                ...
                                case "requestFeedbackData":
                                    {
                                        var Ge = De(o, c);A(Ge, HTMLElement) || b("Received state for an unknown widget: #".concat(c, " / ").concat(n.widgetId), 3078),
                                        ie(Ge, {
                                ...
                                case "closeFeedbackReportIframe":
                                    {
                                        var Xt = Kt(o, c).targetWindow;Xt || b("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                                        vt("".concat(c, "-fr")),
                                        ze(o),
                                        i(o, c, n.widgetId);
                                        break
                                ...
                                case "tokenExpired":
                                    {
                                        var Xe, Yt = n.token;o.isExpired = !0,
                                        (Xe = o.cbExpired) === null || Xe === void 0 || Xe.call(o, Yt),
                                        o.params["refresh-expired"] === Be.Auto && !o.isResetting && R(te.AutoExpire, c);
                                        break
                                    }
                                case "interactiveTimeout":
                                    {
                                ...
                                case "refreshRequest":
                                    {
                                        ...
                                        vt(c),
                                        ze(o),
                                        R(te.ManualRefresh, c);
                                        break
                                    }
                                case "reloadRequest":
                                    {
                                        d(o, n.nextRcV, n.widgetId),
                                        R(si(n.trigger) ? n.trigger : te.Api, c);
                                        break
                                    }
                                case "reloadApiJsRequest":
                                    {
                                ...
                                case "interactiveBegin":
                                    {
                                        var Qe, Re = o.shadow.querySelector("#".concat(c));A(Re, HTMLElement) || b("Cannot layout widget, Element not found (#".concat(c, ")."), 3076),
                                        (Qe = o.cbBeforeInteractive) === null || Qe === void 0 || Qe.call(o),
                                        o.params.appearance === re.InteractionOnly && Ht(Re, o);
                                        break
                                    }
                                case "interactiveEnd":
                                    {
                                ...
                                case "requestExtraParams":
                                    {
                                        ...
                                        var G = De(o, c);G || b("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                                        o.isResetting = !1;
                                        var $e = {},
                                            wt = Y(),
                                            Z = aa(o, G),
                                        ...
                                        ce !== void 0 && ce !== "" && ce.length > on && (ce = void 0),
                                        ie(G, Le({
                                            action: o.action,
                                            apiJsMismatchReloadAttempts: m.apiJsMismatchReloadAttempts,
                                            apiJsMismatchReloadCompletedCount: m.apiJsMismatchReloadCompletedCount,
